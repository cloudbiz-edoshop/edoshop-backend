export const nextDropshippingVariantCode = `
CREATE OR REPLACE FUNCTION next_dropshipping_variant_code(product_code TEXT, color_name TEXT, size_name TEXT)
RETURNS TEXT AS $$
DECLARE
    variant_code TEXT;
    color_code TEXT;
...
export default nextDropshippingVariantCode;
